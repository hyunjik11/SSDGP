...
filename=['experiment_results/mauna320m',num2str(k),'.txt'];
...
l3=huge_set(i8); sf3=large_set(i9);
...
fprintf(fileID,'nll=%4.2f,l1=%4.2f,sf1=%4.2f,cs2=%4.2f,l2=%4.2f,sf2=%4.2f,lper=%4.2f,sfper=%4.2f,l3=%4.2f,sf3=%4.2f,lrq=%4.2f,sfrq=%4.2f\n',nll,l1,sf1,cs2,l2,sf2,lper,sfper,l3,sf3,lrq,sfrq);
fclose(fileID);
end
delete(POOL);
