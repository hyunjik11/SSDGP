...
%    GPCF_PROD_PAK, GPCF_PROD_UNPAK, GPCF_PROD_LP, GP_G
  ...
  elseif nargin == 3 ||  nargin == 4
    ...
    ind = 1:ncf;
    if ~savememory
      DKff=cellfun(@(a) zeros(n,n2), cell(1,numel(x)), 'UniformOutput', 0); %%%Modified by hjk: n changed to n2
    else
      DKff=cellfun(@(a) zeros(n,n2), cell(1,n), 'UniformOutput', 0); %%%Modified by hjk: n changed to n2
    end
    for i=1:ncf
      cf = gpcf.cf{i};
      if ~savememory
