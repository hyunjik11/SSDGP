function [kernel_buffer, kernel_top, kernel_top_history] = skd(x,y,final_depth,num_iter,m_values,seed,S,precond)
...
kernel_top_history = struct('key',{},'lb',{},'ub',{},'gp_var',{},'indicedifs',{});
...
for depth = 1:final_depth
    if depth == 1
        ...
        if isempty(kernel_buffer) % no new kernels found in search
            return
        else
